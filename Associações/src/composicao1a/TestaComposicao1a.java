...
//Este exemplo testa a associação do tipo composição entre Aluno->Residencia,
//mostrando que não é possível ter acesso ao objeto Residencia do Aluno, mas apenas a uma cópia do mesmo.
public class TestaComposicao1a {
